    ...
    <div className="flex flex-col h-screen bg-bg-primary">
      ...
      <header className="flex items-center px-4 h-14 border-b border-border bg-bg-secondary">
        ...
        <div className="flex-1 ml-3">
          ...
          <p className="text-xs text-text-muted">merak-platform</p>
        </div>
      ...
      <main className="flex-1 overflow-y-auto px-4 py-4 space-y-6">
          ...
          <div className="bg-bg-secondary rounded-xl p-4 border border-border">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="font-medium text-text-primary">Create DB migrations</p>
                ...
                <p className="text-xs text-text-muted mt-1">Priority: Normal</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="bg-bg-secondary rounded-xl p-4 border border-warning/30">
            <div className="flex items-start gap-3">
              <div className="w-10 h-10 rounded-lg bg-warning/20 flex items-center justify-center flex-shrink-0">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-warning animate-spin">
                  <path fillRule="evenodd" d="M4.755 10.059a7.5 7.5 0 0 1 12.548-3.364l1.903 1.903h-3.183a.75.75 0 1 0 0 1.5h4.992a.75.75 0 0 0 .75-.75V4.356a.75.75 0 0 0-1.5 0v3.18l-1.9-1.9A9 9 0 0 0 3.306 9.67a.75.75 0 1 0 1.45.388Zm15.408 3.352a.75.75 0 0 0-.919.53 7.5 7.5 0 0 1-12.548 3.364l-1.902-1.903h3.183a.75.75 0 0 0 0-1.5H2.984a.75.75 0 0 0-.75.75v4.992a.75.75 0 0 0 1.5 0v-3.18l1.9 1.9a9 9 0 0 0 15.059-4.035.75.75 0 0 0-.53-.918Z" clipRule="evenodd" />
                </svg>
              </div>
              <div className="flex-1 min-w-0">
                <p className="font-medium text-text-primary">Design RBAC model</p>
                <p className="text-sm text-text-secondary mt-1">Started 3 min ago</p>
                <div className="mt-2 h-2 bg-bg-tertiary rounded-full overflow-hidden">
                  <div className="h-full bg-warning w-[70%] rounded-full" />
                </div>
                <p className="text-xs text-text-muted mt-1">70%</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="bg-bg-secondary rounded-xl p-4 border border-accent/30">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="font-medium text-text-primary">Add rate limiting</p>
                <p className="text-sm text-text-secondary mt-1">3 files, +45 -12</p>
                <button
